...
- negotiates the Relay current protocol at runtime instead of pinning a primary
  protocol in `.env`, and writes the temporary
  `AGENTRELAY_COMPAT_PROTOCOL_VERSIONS="agent-collab-v0.5"` Listener drain lane
